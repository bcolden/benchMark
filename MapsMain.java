...
;
    ...
    String locationDB = "/Users/Noahkennedy/Desktop/locationDB.txt";
    FileWriter fw;
        ...
        */
        ...
        userPrompt.setPositiveButton("Create", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                ...
                markerArray.add(putMarker);
                populateMap();
                writeMarkers(titleInput, descInput, currentCoords);
            }
        });
    ...
    public void writeMarkers(String tempTitle, String tempDesc, LatLng tempLatLng ) {
        try {
            fw = new FileWriter(locationDB, false);
            fw.write("Title: \n");
            //fw.write("Description" + tempDesc+ "\n");
            //fw.write("Latitude: " + tempLatLng.latitude + "\n");
            //fw.write("Longitude" + tempLatLng.longitude + "\n");
        }
        catch(Exception e) {
            Log.e("Exception", "Exception is: " + e);
            Log.e("StackTrace", "Exception is: " + e.getStackTrace());
        }
    }
